...
export const cardDocument5: CardDocument = {
  ...
  name: "Card 5",
  priority: 0,
  source: sourceDocument2.name,
  source_id: sourceDocument2.pk,
  source_verbose: sourceDocument2.name,
  source_type: "google drive",
  dpi: 1200,
  searchq: "card 5",
  extension: "png",
...
export const cardDocument6: CardDocument = {
  ...
  name: "Card 6",
  priority: 0,
  source: sourceDocument3.name,
  source_id: sourceDocument3.pk,
  source_verbose: sourceDocument3.name,
  source_type: "google drive",
  dpi: 1200,
  searchq: "card 6",
  extension: "png",
